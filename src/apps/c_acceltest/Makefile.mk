$(BUILD_APP_DIR)/c_acceltest.elf: $(call rwildcard,$(SRC_DIR)apps/c_acceltest/,*.c) $(BUILD_APP_DIR)/firestorm.o $(BUILD_APP_DIR)/tock.o $(BUILD_APP_DIR)/crt1.o $(BUILD_APP_DIR)/sys.o $(BUILD_APP_DIR)/arch.o $(BUILD_APP_DIR)/fxos8700cq.o $(APP_LIBC)
	@echo "Building $@"
